    ...
    <>
      <div className="bg-[#54d53e]  h-[100vh] p-5 flex relative justify-center align-center ">
        <div className="ml-10 top-[-100px]  absolute ">
          <h1 className=" text-[22rem] font-bold text-[#9ce78f] italic ">NIKE</h1>
        </div>
        ...
        <div className="absolute  flex flex-col bottom-[11%] left-[16%] leading-[4rem] ">
          <Image src={logo} alt="hero image" width={130} height={1500}></Image>
             <p className="text-[2.5rem] font-bold leading-4">JUST DO IT</p>
        </div>

        <div className="absolute  flex flex-row bottom-[15%] right-[14%] gap-6">
          <div className="text-[4rem]  leading-[4rem]  text-[#9ce78f] ">
            <h2>AIR MAX</h2>
            <p>2024</p>
          </div>
